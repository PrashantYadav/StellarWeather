 ...
 */
package com.prashant93y.stellarweather.data;
...
public class WeatherProvider extends ContentProvider {
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case WEATHER:
                normalizeDate(values);
                rowDeleted = db.update(WeatherContract.WeatherEntry.TABLE_NAME,values, selection, selectionArgs);
                break;
            case LOCATION:
                rowDeleted = db.update(WeatherContract.LocationEntry.TABLE_NAME,values, selection,selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
